...
OldSP = 52;     % Controller OUTPUT before [% Strokelength]
NewSP = 58;     % Controller OUTPUT after [% Strokelength]

%Fill in
y0          = 6.56;              % Initial measurement before test [l/hr].
yinf        = 7.6;            % Steady state measurement after test[l/hr].
...
tau     = 38;   % 2. The time it takes to reach tau_pointY_axis [sec]
