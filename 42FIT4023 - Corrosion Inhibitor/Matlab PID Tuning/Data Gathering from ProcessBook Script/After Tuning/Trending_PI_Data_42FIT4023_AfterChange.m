...
ReadFlowTable = detectImportOptions("42FIT4023 Measurement Response After.csv");
ReadFlowTable.VariableNamingRule = 'preserve';
FlowTable = readtable("42FIT4023 Measurement Response After.csv", ReadFlowTable);
...
setpointValues = ones(height(FlowTable), 1) * 5.2; % The initial setpoint

% Define the times when the setpoint changes
setpointChangeTimes = {
    '02-Apr-2024 12:52:23', 6.5;
    '02-Apr-2024 17:02:30', 5.2
};
...
% Plot the data
figure;
plot(timestamps, values, '-', 'LineWidth', 1, 'DisplayName', '42FIT4023 Flow [l/hr]');
...
changeSetpoint1 = abs(5.2-6.5);
timeConstant1 = 0.632*changeSetpoint1 + 5.2

%Timeconstant 2 after setpoint change 2
changeSetpoint2 = abs(6.5-5.2);
timeConstant2 = 6.5 - 0.632*changeSetpoint2

% Define timestamps for when the time constants are relevant
timeConstant1Timestamp = datetime('02-Apr-2024 12:54:20', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
timeConstant2Timestamp = datetime('02-Apr-2024 17:04:24', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
...
xline(datetime('02-Apr-2024 12:55:12', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
xline(datetime('02-Apr-2024 17:06:00', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
...
% Enhance visuals
title('42FIT4023 Flow and Setpoint Over Time, after changes','FontSize', 14, 'FontWeight', 'bold');
