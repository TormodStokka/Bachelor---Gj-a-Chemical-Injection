...
ReadFlowTable = detectImportOptions("42FIT4023 Measurement Response Before.csv");
ReadFlowTable.VariableNamingRule = 'preserve';
FlowTable = readtable("42FIT4023 Measurement Response Before.csv", ReadFlowTable);
...
setpointChangeTimes = {
    '31-Mar-2024 13:45:11', 6.5;
    '31-Mar-2024 18:35:09', 5.2
};
...
timeConstant1Timestamp = datetime('31-Mar-2024 14:07:33', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
timeConstant2Timestamp = datetime('31-Mar-2024 18:56:25', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
...
xline(datetime('31-Mar-2024 14:20:02', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
xline(datetime('31-Mar-2024 19:17:21', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
...
% Enhance visuals
title('42FIT4023 Flow and Setpoint Over Time, before changes');
