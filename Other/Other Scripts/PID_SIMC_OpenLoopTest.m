...
OldSP = 30;     % Controller OUTPUT before [% Strokelength]
NewSP = 40;     % Controller OUTPUT after [% Strokelength]

%Fill in
y0          = ;              % Initial measurement before test [l/hr].
yinf        = ;            % Steady state measurement after test[l/hr].
...
theta   = ;   % 1. Time delay before change [sec]
tau     = ;   % 2. The time it takes to reach tau_pointY_axis [sec]
