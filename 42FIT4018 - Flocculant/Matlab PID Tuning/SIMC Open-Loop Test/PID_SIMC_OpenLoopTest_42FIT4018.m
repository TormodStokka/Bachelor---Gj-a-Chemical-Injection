...
OldSP = 31;     % Controller OUTPUT before [% Strokelength]
NewSP = 37;     % Controller OUTPUT after [% Strokelength]

%Fill in
y0          = 0.88;              % Initial measurement before test [l/hr].
yinf        = 1.65;            % Steady state measurement after test[l/hr].
...
theta   = 21;   % 1. Time delay before change [sec]
tau     = 11;   % 2. The time it takes to reach tau_pointY_axis [sec]
