...
ReadFlowTable = detectImportOptions("42FIT4018 Measurement Response Before.csv");
ReadFlowTable.VariableNamingRule = 'preserve';
FlowTable = readtable("42FIT4018 Measurement Response Before.csv", ReadFlowTable);
...
setpointChangeTimes = {
    '31-Mar-2024 13:40:24', 1.5;
    '31-Mar-2024 18:34:48', 1.2
};
...
% Plot the data
figure;
plot(timestamps, values, '-', 'LineWidth', 1, 'DisplayName', '42FIT4018 Flow [l/hr]');
...
timeConstant1Timestamp = datetime('31-Mar-2024 13:40:44', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
timeConstant2Timestamp = datetime('31-Mar-2024 18:35:06', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
...
xline(datetime('31-Mar-2024 13:45:21', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
xline(datetime('31-Mar-2024 18:41:02', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');


% Customize and position the legend
lgd = legend('Location', 'northeast', 'FontSize', 10);
lgd.Title.String = 'Legend';
lgd.Title.FontWeight = 'bold';

% Enhance visuals
title('42FIT4018 Flow and Setpoint Over Time, before changes','FontSize', 14, 'FontWeight', 'bold');
...
yPadding = (max([values; setpointValues]) - min([values; setpointValues])) * 0.3;
