...
ReadFlowTable = detectImportOptions("42FIT4018 Measurement Response After.csv");
ReadFlowTable.VariableNamingRule = 'preserve';
FlowTable = readtable("42FIT4018 Measurement Response After.csv", ReadFlowTable);
...
setpointChangeTimes = {
    '02-Apr-2024 12:52:15', 1.5;
    '02-Apr-2024 17:02:47', 1.2
};
...
timeConstant1Timestamp = datetime('02-Apr-2024 12:55:39', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
timeConstant2Timestamp = datetime('02-Apr-2024 17:06:20', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
...
xline(datetime('02-Apr-2024 12:58:02', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'HandleVisibility', 'off');
xline(datetime('02-Apr-2024 17:07:22', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'HandleVisibility', 'off');
...
% Enhance visuals
title('42FIT4018 Flow and Setpoint Over Time, after changes', 'FontSize', 14, 'FontWeight', 'bold');
...
yPadding = (max([values; setpointValues]) - min([values; setpointValues])) * 0.15;
