...
ReadFlowTable = detectImportOptions("42FIT4011 Measurement Response After.csv");
ReadFlowTable.VariableNamingRule = 'preserve';
FlowTable = readtable("42FIT4011 Measurement Response After.csv", ReadFlowTable);
...
setpointChangeTimes = {
    '02-Apr-2024 12:51:56', 1.5;
    '02-Apr-2024 17:02:55', 1.2
};
...
timeConstant1Timestamp = datetime('02-Apr-2024 12:56:35', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
timeConstant2Timestamp = datetime('02-Apr-2024 17:06:58', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'); 
...
xline(datetime('02-Apr-2024 12:58:24', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
xline(datetime('02-Apr-2024 17:12:07', 'InputFormat', 'dd-MMM-yyyy HH:mm:ss', 'Locale', 'en_US'), '--m', 'LineWidth', 1, 'DisplayName', 'Specific Time 14:07:51', 'HandleVisibility', 'off');
...
% Enhance visuals
title('42FIT4011 Flow and Setpoint Over Time, after changes');
