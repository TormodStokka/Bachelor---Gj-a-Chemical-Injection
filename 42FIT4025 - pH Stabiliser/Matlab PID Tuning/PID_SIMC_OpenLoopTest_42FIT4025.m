...
%FILL IN
OldSP = 47;     % Controller OUTPUT before [% Strokelength]
NewSP = 53;     % Controller OUTPUT after [% Strokelength]

%Fill in
y0          = 20.37;            % Initial measurement before test [l/hr].
yinf        = 24.05;            % Steady state measurement after test[l/hr].
...
theta   = 17;   % 1. Time delay before change [sec]
...
% Decided for slower control with +30 for tauc
tauc = theta+30; 
